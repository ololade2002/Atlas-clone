  ...
  return (
    <section id='topContent' className='w-full flex justify-center  '>
      <div className='pt-24 pb-28 lg:pt-44 lg:pb-52 w-full px-4 lg:px-0 lg:w-[55%] flex flex-col gap-20 lg:gap-44'>
        <div className=''>
            <h2 className='text-gradient text-[22px] md:text-[27px] leading-[1.3] font-[400] font-rale text-center'>With Atlas, you can finally get tables at the hardest-to-book restaurants, find the perfect 
