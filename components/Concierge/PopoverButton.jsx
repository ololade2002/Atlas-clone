...
function PopoverButton() {
  ...
  return (
    <div onClick={togglePopover} className="text-image z-40 ">
     <h2 className='location uppercase flex items-center justify-center font-rale  gap-2 hover:bg-[rgba(255,255,255,0.3)]'><FaLocationDot/>coachella access pass, indio </h2>
